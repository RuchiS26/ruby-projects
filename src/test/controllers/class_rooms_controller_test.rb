...
class ClassRoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_room" do
    assert_difference('ClassRoom.count') do
      post class_rooms_url, params: { class_room: { building_name: @class_room.building_name, floor: @class_room.floor, is_active: @class_room.is_active, room_name: @class_room.room_name, seat: @class_room.seat } }
    end
  ...
  test "should update class_room" do
    patch class_room_url(@class_room), params: { class_room: { building_name: @class_room.building_name, floor: @class_room.floor, is_active: @class_room.is_active, room_name: @class_room.room_name, seat: @class_room.seat } }
